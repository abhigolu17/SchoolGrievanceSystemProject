			...
			<div class="col-lg-7 mx-auto">
				<div class="card mt-2 mx-auto p-4 bg-light">
					<div class="card-body bg-light">
						...
						<div class="container">
							<form  action="responseAdmin" method="post" id="contact-form" role="form">								
								<div class="controls">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="form_email">Email *</label> <input
													id="form_email" type="email" name="qemail"
													class="form-control" value="${email}"
													placeholder="${item.email}" required="required"
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea id="form_message" name="comment"
